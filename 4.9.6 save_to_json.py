...
Выберите 1 любую категорию  на сайте тренажёре(https://parsinger.ru/html/index1_page_1.html),
...
отступом в 4 пробела. Ключи в блоке description должны быть получены автоматически из
